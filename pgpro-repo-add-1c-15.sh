#!/bin/sh
# This script finds out which Postgresql for 1C 15 package repository is
...
REPO="http://repo.postgrespro.ru/1c/1c-15"
PRODUCT_NAME="Postgresql for 1C 15"
LISTNAME="postgresql-1c-15"
REPOUSER=
PASSWORD=
if [ "$(id -u)" -ne 0 ]; then
